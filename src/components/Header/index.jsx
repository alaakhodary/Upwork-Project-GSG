import { DivLogos } from "../../pages/Login/style";

import { DivFlex, DivLastContent, LogOut } from "./style";

import Profile from "../Profile";
import Navbar from "../Navbar";

import imgage from "../../assests/profile.jpg";
  ...
  return (
    <header>
      <DivFlex>
        ...
        <Navbar />
        <Searchbox width="500px" marginLift="11rem" />
        <DivLastContent>
          <QuestionMarkIcon />
          <SendIcon />
          <NotificationsNoneOutlinedIcon />
          <LogOut onClick={logout}>Log out</LogOut>
          <Profile imgageProfile={imgage} />
        </DivLastContent>
      </DivFlex>
    </header>
  );
